...
<div id="wrap" class="wrap_tab right">
    ...
    <div id="tab_2" class="tab">
        <div style="padding: 5px;">
            <p>Графен — монослой атомов углерода, полученный в октябре 2004 года в Манчестерском университете (The
               при комнатной температуре, благодаря чему с решением проблемы формирования.</p>
        </div>
    </div>
</div>
